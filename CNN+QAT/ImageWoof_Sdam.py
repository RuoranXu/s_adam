...
class QATNet(nn.Module):
    def __init__(self):
        ...
        self.conv3 = QuantizedConv2d(32, 64, 3, 1) # 38 -> 36
        # MaxPool 2x2 after conv1 -> 79
        # MaxPool 2x2 after conv2 -> 38
        # MaxPool 2x2 after conv3 -> 18
        # Feature map size: 64 channels * 18 * 18
        self.fc1 = nn.Linear(64 * 18 * 18, 10)  # 10 classes
...
if __name__ == "__main__":
    sys.stdout = Logger('training_log_prox_adamw_sadam_imagewoof.txt')
    ...
    plt.tight_layout()
    plt.savefig('sadam_vs_proxsgd_adamw_imagewoof.png', dpi=300)
    print("Saved plot to sadam_vs_proxsgd_adamw_imagewoof.png")
    plt.show()