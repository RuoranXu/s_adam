...
def run_comparison():
    ...
    model_prox = get_pretrained_model(num_classes=10).to(device)
    ...
    torch.manual_seed(42)
    model_adamw = get_pretrained_model(num_classes=10).to(device)
    ...
    torch.manual_seed(42)
    model_sadam = get_pretrained_model(num_classes=10).to(device)
...
if __name__ == "__main__":
    sys.stdout = Logger('training_log_CIFAR10_resnet_learning64.txt')
    ...
    plt.tight_layout()
    plt.savefig('sadam_vs_proxsgd_adamw_CIFAR10_resnet64.png', dpi=300)
    print("Saved plot to sadam_vs_proxsgd_adamw_CIFAR10_resnet64.png")
    plt.show()
