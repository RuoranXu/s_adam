...
if __name__ == "__main__":
    sys.stdout = Logger('training_log_prox_adamw_sadam_imagewoof_resnet_batch64.txt')
    ...
    plt.tight_layout()
    plt.savefig('sadam_vs_proxsgd_adamw_imagewoof_resnet_batch64.png', dpi=300)
    print("Saved plot to sadam_vs_proxsgd_adamw_imagewoof_resnet_batch64.png")
    plt.show()