...
def run_comparison():
    ...
    opt_prox = ProxSGD(model_prox.parameters(), lr=0.001, momentum=0.9, l1_lambda=1e-4)
    ...
    opt_adamw = AdamW(model_adamw.parameters(), lr=0.001, weight_decay=1e-3)
...
if __name__ == "__main__":
    sys.stdout = Logger('training_log_prox_adamw_sadam.txt')
    ...
    plt.tight_layout()
    plt.savefig('sadam_vs_proxsgd_adamw.png', dpi=300)
