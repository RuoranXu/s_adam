...
class QATNet(nn.Module):
    def __init__(self):
        ...
        # Feature map size: 32 channels * 14 * 14
        self.fc1 = nn.Linear(32 * 14 * 14, 200)  # 200 classes
...
def run_comparison():
    ...
    print(f"{'AdamW (Base)':<20} | {total_time_adamw:.4f}")
...
if __name__ == "__main__":
    sys.stdout = Logger('training_log_prox_adamw_sadam_tinyimagenet.txt')
    ...
    plt.tight_layout()
    plt.savefig('sadam_vs_proxsgd_adamw_tinyimagenet.png', dpi=300)
    print("Saved plot to sadam_vs_proxsgd_adamw_tinyimagenet.png")
    plt.show()
